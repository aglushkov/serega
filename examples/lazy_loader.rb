...
class UserSerializer < AppSerializer
  ...
  attribute :last_name
  attribute :posts, serializer: "PostSerializer", many: true, lazy: UsersPostsLoader
end

class PostSerializer < AppSerializer
  attribute :comments, serializer: "CommentSerializer", many: true, lazy: PostsCommentsLoader
end

class CommentSerializer < AppSerializer
  attribute :text
  attribute :views_count, lazy: CommentsViewsLoader
end
